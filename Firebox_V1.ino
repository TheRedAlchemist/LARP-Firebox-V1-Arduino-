#include <FastLED.h>
//Code based on https://www.instructables.com/LED-Flame-Controlled-by-Noise/
//https://github.com/edabot/perlin_wheel/blob/master/perlin_wheel_neopixel_trinket.ino
//Due credit given to the above.
#include <Adafruit_NeoPixel.h>
//Library for the WS2812B RGB LED 12bit / 12 Pixel Ring

//Global defines - Good Practice to have them here
//The two Hardware LED halo ring defines
#include <FastLED.h>
...
void fillnoise() {
  ...
  for (int i = 0; i < NUM_LEDS; i++) {
    ...
    int hue = (int)(noiseValH * colorRange + colorStart)-300;
